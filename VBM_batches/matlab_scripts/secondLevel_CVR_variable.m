%-----------------------------------------------------------------------
% Second-level analysis: Multiple Regression, when a cardiovascular risk
% (CVR) variable is independent and brain grey matter density is 
% dependent variable when age, TIV, sex were covariates of no interest 
% within Factorial Design specification, followed by Model review and 
% Model estimation steps
% based on CAT12.8.2 VBM (voxel-based morphometry) 
% spm SPM - SPM12 (7771)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.factorial_design.dir = {'/path/to/CVR_variable'};
...
matlabbatch{1}.spm.stats.factorial_design.cov(4).cname = 'CVR_variable';
